...
router.get('/', function (req, res) {
 res.render('index', { title: 'Mountains App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'Mountains App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Mountains App Login', user : req.user });
 });
